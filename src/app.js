...
// ===== Konstanty =====
const STORAGE_DATE_SUFFIX = getStorageDateString(new Date());
const STORAGE_KEYS = {
    events: `copilotcal_events_${STORAGE_DATE_SUFFIX}`,
    settings: `copilotcal_settings_${STORAGE_DATE_SUFFIX}`
};
...
/** Vrátí datum jako řetězec YYYYMMDD pro klíče localStorage */
function getStorageDateString(date) {
...
/** Zobrazení počtu viditelných událostí v aktuálním týdnu */
function renderEventCount() {
    ...
    dom.eventCount.textContent = eventCount;
